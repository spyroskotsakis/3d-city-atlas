...
const CITY_LANDMARKS = {
  ...
  manila: [
    ...
    { label: 'San Agustin', targetKey: 'sanAgustin' },
    { label: 'Casa Manila', targetKey: 'casaManila' },
...
window.__ROME_METRICS__ = {
  ...
  jeepneys: world.metrics.jeepneys,
  motorbikes: world.metrics.motorbikes,
  tricycles: world.metrics.tricycles,
  trains: world.metrics.trains,
